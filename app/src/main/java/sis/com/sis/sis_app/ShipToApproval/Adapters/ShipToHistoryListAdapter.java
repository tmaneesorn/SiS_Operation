...
public class ShipToHistoryListAdapter extends BaseAdapter {
    ...
    public ShipToHistoryListAdapter(Context context, List<ShipToObject> list)
    {
        mContext=context;
        mList=list;
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ShipToHistoryListAdapter.Holder holder=new ShipToHistoryListAdapter.Holder();
        View rowView;
...
//        if (object.so_total < 0) {
//            holder.tvAmount.setText(amount);
//            holder.tvAmount.setTextColor(mContext.getResources().getColor(R.color.colorRed));
//        }
//
//        if (object.so_profit < 0) {
...
//        }
        ...
        else if (holder.tvStatus.getText().equals("Wait for GM")){
            holder.tvStatus.setText(R.string.main_document_status_waiting_gm);
